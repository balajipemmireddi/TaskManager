...
INSERT INTO projects (title, description, created_by_id, created_at) VALUES
-- E-commerce Projects
...
INSERT INTO tasks (title, description, status, priority, due_date, project_id, assigned_to_id, created_at) VALUES
('Setup project repository', 'Initialize Git repo and project structure', 'DONE', 'HIGH', NOW() - INTERVAL '85 days', 1, 6, NOW() - INTERVAL '90 days'),
('Design database schema', 'Create ERD and database design', 'DONE', 'HIGH', NOW() - INTERVAL '80 days', 1, 7, NOW() - INTERVAL '85 days'),
('Implement user authentication', 'JWT-based auth system', 'DONE', 'HIGH', NOW() - INTERVAL '75 days', 1, 8, NOW() - INTERVAL '80 days'),
('Create product API endpoints', 'REST API for product management', 'IN_PROGRESS', 'HIGH', NOW() + INTERVAL '5 days', 1, 9, NOW() - INTERVAL '75 days'),
('Build shopping cart functionality', 'Add to cart and checkout flow', 'IN_PROGRESS', 'MEDIUM', NOW() + INTERVAL '10 days', 1, 6, NOW() - INTERVAL '70 days'),
('Implement payment processing', 'Stripe integration', 'TODO', 'HIGH', NOW() + INTERVAL '15 days', 1, 7, NOW() - INTERVAL '65 days'),
('Design product listing page', 'UI/UX for product catalog', 'DONE', 'MEDIUM', NOW() - INTERVAL '60 days', 1, 8, NOW() - INTERVAL '65 days'),
('Create order management', 'Order tracking system', 'IN_PROGRESS', 'MEDIUM', NOW() + INTERVAL '20 days', 1, 9, NOW() - INTERVAL '60 days'),
('Implement search functionality', 'Product search with filters', 'TODO', 'MEDIUM', NOW() + INTERVAL '25 days', 1, 6, NOW() - INTERVAL '55 days'),
('Add product reviews', 'Rating and review system', 'TODO', 'LOW', NOW() + INTERVAL '30 days', 1, 7, NOW() - INTERVAL '50 days'),
('Setup email notifications', 'Order confirmation emails', 'TODO', 'MEDIUM', NOW() + INTERVAL '35 days', 1, 8, NOW() - INTERVAL '45 days'),
('Implement wishlist feature', 'Save products for later', 'TODO', 'LOW', NOW() + INTERVAL '40 days', 1, 9, NOW() - INTERVAL '40 days'),
('Create admin dashboard', 'Admin panel for management', 'IN_PROGRESS', 'HIGH', NOW() + INTERVAL '12 days', 1, 6, NOW() - INTERVAL '35 days'),
('Add inventory management', 'Stock tracking system', 'TODO', 'MEDIUM', NOW() + INTERVAL '45 days', 1, 7, NOW() - INTERVAL '30 days'),
('Implement discount codes', 'Coupon and promo system', 'TODO', 'LOW', NOW() + INTERVAL '50 days', 1, 8, NOW() - INTERVAL '25 days'),
('Setup analytics tracking', 'Google Analytics integration', 'TODO', 'LOW', NOW() + INTERVAL '55 days', 1, 9, NOW() - INTERVAL '20 days'),
('Create mobile responsive design', 'Mobile-first approach', 'IN_PROGRESS', 'HIGH', NOW() + INTERVAL '8 days', 1, 6, NOW() - INTERVAL '15 days'),
('Implement lazy loading', 'Performance optimization', 'TODO', 'MEDIUM', NOW() + INTERVAL '60 days', 1, 7, NOW() - INTERVAL '10 days'),
('Add social media integration', 'Share products on social media', 'TODO', 'LOW', NOW() + INTERVAL '65 days', 1, 8, NOW() - INTERVAL '5 days'),
('Write API documentation', 'Swagger/OpenAPI docs', 'TODO', 'MEDIUM', NOW() + INTERVAL '70 days', 1, 9, NOW());

-- Project 2: Payment Gateway (15 tasks)
INSERT INTO tasks (title, description, status, priority, due_date, project_id, assigned_to_id, created_at) VALUES
('Research payment providers', 'Compare Stripe, PayPal, Square', 'DONE', 'HIGH', NOW() - INTERVAL '80 days', 2, 10, NOW() - INTERVAL '85 days'),
('Setup Stripe account', 'Create and configure Stripe', 'DONE', 'HIGH', NOW() - INTERVAL '75 days', 2, 11, NOW() - INTERVAL '80 days'),
('Implement Stripe checkout', 'Payment form integration', 'DONE', 'HIGH', NOW() - INTERVAL '70 days', 2, 12, NOW() - INTERVAL '75 days'),
('Add PayPal integration', 'PayPal payment option', 'IN_PROGRESS', 'HIGH', NOW() + INTERVAL '7 days', 2, 10, NOW() - INTERVAL '70 days'),
('Implement refund system', 'Handle payment refunds', 'TODO', 'MEDIUM', NOW() + INTERVAL '14 days', 2, 11, NOW() - INTERVAL '65 days'),
('Add payment webhooks', 'Handle payment events', 'IN_PROGRESS', 'HIGH', NOW() + INTERVAL '10 days', 2, 12, NOW() - INTERVAL '60 days'),
('Create payment history', 'Transaction log and history', 'TODO', 'MEDIUM', NOW() + INTERVAL '21 days', 2, 10, NOW() - INTERVAL '55 days'),
('Implement recurring payments', 'Subscription billing', 'TODO', 'MEDIUM', NOW() + INTERVAL '28 days', 2, 11, NOW() - INTERVAL '50 days'),
('Add payment security', 'PCI compliance measures', 'IN_PROGRESS', 'HIGH', NOW() + INTERVAL '5 days', 2, 12, NOW() - INTERVAL '45 days'),
('Setup fraud detection', 'Fraud prevention system', 'TODO', 'HIGH', NOW() + INTERVAL '35 days', 2, 10, NOW() - INTERVAL '40 days'),
('Create invoice generation', 'PDF invoice creation', 'TODO', 'MEDIUM', NOW() + INTERVAL '42 days', 2, 11, NOW() - INTERVAL '35 days'),
('Add multi-currency support', 'International payments', 'TODO', 'LOW', NOW() + INTERVAL '49 days', 2, 12, NOW() - INTERVAL '30 days'),
('Implement payment analytics', 'Revenue tracking dashboard', 'TODO', 'MEDIUM', NOW() + INTERVAL '56 days', 2, 10, NOW() - INTERVAL '25 days'),
('Add saved payment methods', 'Store customer cards', 'TODO', 'LOW', NOW() + INTERVAL '63 days', 2, 11, NOW() - INTERVAL '20 days'),
('Write payment tests', 'Unit and integration tests', 'TODO', 'MEDIUM', NOW() + INTERVAL '70 days', 2, 12, NOW() - INTERVAL '15 days');
...
INSERT INTO tasks (title, description, status, priority, due_date, project_id, assigned_to_id, created_at) VALUES
('Design product data model', 'Define product attributes', 'DONE', 'HIGH', NOW() - INTERVAL '75 days', 3, 13, NOW() - INTERVAL '80 days'),
('Create category system', 'Product categorization', 'DONE', 'HIGH', NOW() - INTERVAL '70 days', 3, 14, NOW() - INTERVAL '75 days'),
('Implement product CRUD', 'Create, read, update, delete', 'IN_PROGRESS', 'HIGH', NOW() + INTERVAL '5 days', 3, 15, NOW() - INTERVAL '70 days'),
('Add product images', 'Image upload and management', 'IN_PROGRESS', 'MEDIUM', NOW() + INTERVAL '12 days', 3, 16, NOW() - INTERVAL '65 days'),
('Create product variants', 'Size, color variations', 'TODO', 'MEDIUM', NOW() + INTERVAL '19 days', 3, 13, NOW() - INTERVAL '60 days'),
('Implement bulk import', 'CSV product import', 'TODO', 'LOW', NOW() + INTERVAL '26 days', 3, 14, NOW() - INTERVAL '55 days'),
('Add product tags', 'Tagging system', 'TODO', 'LOW', NOW() + INTERVAL '33 days', 3, 15, NOW() - INTERVAL '50 days'),
('Create product comparison', 'Compare multiple products', 'TODO', 'LOW', NOW() + INTERVAL '40 days', 3, 16, NOW() - INTERVAL '45 days'),
('Implement stock alerts', 'Low stock notifications', 'TODO', 'MEDIUM', NOW() + INTERVAL '47 days', 3, 13, NOW() - INTERVAL '40 days'),
('Add product SEO', 'Meta tags and descriptions', 'TODO', 'MEDIUM', NOW() + INTERVAL '54 days', 3, 14, NOW() - INTERVAL '35 days');

-- Add more tasks for remaining projects (Projects 4-10)
-- Each with 8-12 tasks to reach 200+ total tasks

-- Project 4-10 tasks (simplified for brevity)
INSERT INTO tasks (title, description, status, priority, due_date, project_id, assigned_to_id, created_at)
SELECT 
